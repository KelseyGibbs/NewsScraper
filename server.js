...
var MONGODB_URI = process.env.MONGODB_URI || "mongodb://localhost/mongoHeadliners6666";
...
app.get("/scrape", function (req, res) {
    ...
    axios.get("https://www.npr.org/sections/news/").then(function (response) {
        ...
        $("div.item-info").each(function (i, element) {
            // Create an empty object to store our desired data
            var result = {};
            // Grab every h2 element with a title class and save the text and href. Do the same for the p element with a teaser class
            result.title = $(this)
                .children("h2.title")
                .children("a")
                .text();
